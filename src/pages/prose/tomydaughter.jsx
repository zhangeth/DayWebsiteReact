...
paragraph4[7] = <div>Later that night, I found Mr. Krapov’s house online after a couple Google searches. In my hand, the knife felt strangely weightless as I unlocked the window and sliced the screen door open. Mr. Krapov, a middle-aged man with graying hair and a mousy mustache, laid sideways across the couch, one leg dangling off the edge. One of his hands was dug into the bowl of popcorn that was balanced on the crest of his belly. A plaque sat on the coffee table in front of Mr. Krapov, reading <em>Best Middle School Teacher of the Year!</em></div>
...
paragraph5[3] = <div>I think of the pink tongue, preserved in a jar, presented next to the plaque that says <em>Best Middle School Teacher of the Year!</em></div>
paragraph5[4] = "“What happened to Brent Holland?” "
paragraph5[5] = <div>I think of that jackass partner of your law firm that sexually harassed you and refused to promote you when you rejected his advances, his hand mummified and propped on top of the jar with the pink tongue. I no longer want to lie, but I no longer want to tell you the truth if it hurts you. <em>I did it for you</em> would only break you, so instead, I smile gently and point at the food with my spoon. “Charlotte, eat your food. Your father would go rabid knowing that you weren’t eating such delicious Chinese food.”</div>
...
paragraph6[6] = <div>One day, you came back with a bruise around your eye, flowering into vibrant blues and purples across your cheek. <em>Father punched me, but it was an accident,</em> you said. <em>I was disappointing him.</em></div>
...
paragraph7[2] = <div>You never read <em>Charlotte’s Web</em> particularly carefully, so I doubt you’ll know this. Did you know, Charlotte, that after spider mothers give birth, they die? They spend all their energy and time on their eggs that they no longer have the energy to stay alive.</div>
