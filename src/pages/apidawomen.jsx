    ...
    return(
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-8">
                        <h6 class="h6v2 pt-4 pb-2" style={{textAlign:'center'}}> WOMEN'S HISTORY MONTH </h6>

                        <h2 class="h2v2 py-4" style={{textAlign:'center'}}> Notable APIDA Women to Spotlight During Women's History Month </h2>
                        ...
                        <p class="pv2 py-2">
                            Patsy Takemoto Mink made history with a number of “firsts.” First Japanese American to practice law in Hawaii. First woman of color—and the first Asian American woman—elected to the United States House of Representatives. And in 1972, Mink became the first Asian American to run for the Democratic nomination for president. A tireless advocate for women’s rights, Mink made it her mission in Congress to craft and champion legislation that opened doors for more women to earn an education and join the workforce. Mink was posthumously honored with the Presidential Medal of Freedom in 2014.
                        </p>
                        ...
                        <a href="https://hello.giggles.com/asian-pacific-islander-women/">
                            <p class="pv2" style={{textAlign:'center'}}>
                                https://hello.giggles.com/asian-pacific-islander-women/
                            </p>
                        </a>
                        <a href="https://olympics.com/en/athletes/naomi-osaka">
                            <p class="pv2" style={{textAlign:'center'}}>
                                https://olympics.com/en/athletes/naomi-osaka
                            </p>
                        </a>
                        <a href="https://www.ywcampls.org/all-our-voices-blog/20-asian-american-and-pacific-islander-women-to-know">
                            <p class="pv2" style={{textAlign:'center'}}>
