        ...
        <div>
            <div className="about-row p-4 pb-0 pe-lg-0 border shadow-lg">
                <div className="col p-3 p-lg-5 pt-lg-3">
                    <h1 className="about-title">ABOUT DAY</h1>
                    <p className="about-body">We are a group of Asian youths striving to uplift marginalized communities through education, activism, and celebration. 
